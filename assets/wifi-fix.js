(() => {
  ...
  style.textContent = '.notice-card{min-height:390px;display:flex;flex-direction:column}.notice-card p{font-size:17px!important;font-weight:600}.notice-card #enter{margin-top:auto}.wifi-link{padding:6px 11px!important;line-height:1.25}.wifi-return{border:0;border-radius:999px;padding:11px 18px;background:#ffd782;color:#173b43;font:800 17px "Noto Sans KR",sans-serif;cursor:pointer}';
